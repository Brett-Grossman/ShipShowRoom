...
const ShipForm = () => {
    ...
    'Greycat Industrial','Crusader Industries']
    ...
    <div className="row">
        <div className="col-md-12">
            ...
            <textarea type="text" id="shipReview" className="form-control" placeholder="Enter your review here" name="shipReview" value={shipReview} onChange={shipReviewHandler}/>
